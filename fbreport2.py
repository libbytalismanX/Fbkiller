...
@@ -0,0 +1,21 @@
=======================================<br>
<h1> PCG PCA FBREPORT v0.1 </h1><br><br>
...
=======================================<br>
DEVELOP BY JOHN EX DEV FORK WITH DRAGON -PCGPH-PCA
=======================================<br>
...
def banner():
    print()
    print("""  \t \t\033[93m PCGPH-PCA [ FB REPORT ]
...
TOKEN = '6609273971:AAGrugk9EHlPA28eI4qkv4ZJee8ZJBIenzk'   #change the token here
CHAT_ID = '5895970842'   #change the chat id here
